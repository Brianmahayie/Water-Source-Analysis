...
# Abdulai B
kobo_data[kobo_data$source_photo == "1762865226663.jpg", "manager_gender"] <- "Female"
kobo_data[kobo_data$source_photo == "1762865226663.jpg", "owner_type"] <- "Household"
kobo_data[kobo_data$source_photo == "1762865226663.jpg", "source_age"] <- "20+ years"
kobo_data[kobo_data$source_photo == "1762870443737.jpg", "daily_schedule"] <- "All Day"
kobo_data[kobo_data$source_photo == "1762870443737.jpg", "days_per_week"] <- "7 days per week"
kobo_data[kobo_data$source_photo == "1762870443737.jpg", "opening_time"] <- "5am"
kobo_data[kobo_data$source_photo == "1763030485469.jpg", "zone"] <- "Portee Wharf"
kobo_data[kobo_data$source_photo == "1762870443737.jpg", "daily_schedule"] <- "All day"

# Abdulai K
kobo_data[kobo_data$source_photo == "1762856519831.jpg", "access_rights"] <- "Anybody"
kobo_data[kobo_data$source_photo == "1762856519831.jpg", "price_change"] <- "Yes"
kobo_data[kobo_data$source_photo == "1762856519831.jpg", "price_per_jerrycan"] <- 1
kobo_data[kobo_data$source_photo == "1762856519831.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1762956342305.jpg", "access_rights"] <- "Anybody"
kobo_data[kobo_data$source_photo == "1762956342305.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1762956342305.jpg", "price_per_jerrycan"] <- 1
kobo_data[kobo_data$source_photo == "1762956342305.jpg", "price_per_month"] <- 0

# Jamiatu
kobo_data[kobo_data$source_photo == "1762854513791.jpg", "respondent_name"] <- "Ibrahim Jalloh"
...
kobo_data[kobo_data$source_photo == "1763118663989.jpg", "opening_time"] <- "7am"
kobo_data[kobo_data$source_photo == "1763029369673.jpg", "source_age"] <- "20+ years"
kobo_data[kobo_data$source_photo == "1763029369673.jpg", "manager_gender"] <- "Male"
kobo_data[kobo_data$source_photo == "1763029369673.jpg", "owner_type"] <- "Committee"
kobo_data[kobo_data$source_photo == "1763029369673.jpg", "users_per_day"] <- "0"

# Joana
kobo_data[kobo_data$source_photo == "1762855960522.jpg", "price_change"] <- "No"

# Musa 
kobo_data[kobo_data$source_photo == "1762853482960.jpg", "manager_gender"] <- "Female"
kobo_data[kobo_data$source_photo == "1762856784217.jpg", "respondent_name"] <- "Amanda Jones"
kobo_data[kobo_data$source_photo == "1762865592920.jpg", "access_rights"] <- "Community"
kobo_data[kobo_data$source_photo == "1762865592920.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1762865592920.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1762865592920.jpg", "price_per_month"] <- "10"
kobo_data[kobo_data$source_photo == "1762867216335.jpg", "access_rights"] <- "Community"
kobo_data[kobo_data$source_photo == "1762867216335.jpg", "price_change"] <- "Yes"
kobo_data[kobo_data$source_photo == "1762867216335.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1762867216335.jpg", "price_per_month"] <- 0

# Moses
kobo_data[kobo_data$source_photo == "1763200512880.jpg", "price_change"] <- 0
kobo_data[kobo_data$source_photo == "1763200512880.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763200512880.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763202790648.jpg", "price_change"] <- 0
kobo_data[kobo_data$source_photo == "1763202790648.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763202790648.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763203566533.jpg", "price_change"] <- 0
kobo_data[kobo_data$source_photo == "1763203566533.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763203566533.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763204742486.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1763204742486.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763204742486.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763208229214.jpg", "percent_women_gatherers"] <- 60
kobo_data[kobo_data$source_photo == "1763208229214.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1763208229214.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763208229214.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763209899556.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1763209899556.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763209899556.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763211388128.jpg", "percent_women_gatherers"] <- 70
kobo_data[kobo_data$source_photo == "1763211388128.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1763211388128.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763211388128.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763212023654.jpg", "percent_women_gatherers"] <- 75
kobo_data[kobo_data$source_photo == "1763212023654.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1763212023654.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763212023654.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763215463057.jpg", "percent_women_gatherers"] <- 80
kobo_data[kobo_data$source_photo == "1763215463057.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1763215463057.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763215463057.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763289940199.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1763289940199.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763289940199.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763203995442.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1763203995442.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763203995442.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763289940199.jpg", "percent_women_gatherers"] <- 50
kobo_data[kobo_data$source_photo == "1763200512880.jpg", "percent_women_gatherers"] <- 70
kobo_data[kobo_data$source_photo == "1763207174198.jpg", "percent_women_gatherers"] <- 70

kobo_data[kobo_data$source_photo == "1763204742486.jpg", "percent_women_gatherers"]
kobo_data[kobo_data$source_photo == "1763215463057.jpg", "respondent_name"]
kobo_data[kobo_data$source_photo == "1763287530385.jpg", "owner_type"]
kobo_data[kobo_data$source_photo == "1763287530385.jpg", "respondent_name"]
kobo_data[kobo_data$source_photo == "1763200512880.jpg",]# "price_change"]
	

# Joseph 
kobo_data[kobo_data$source_photo == "1763210997150.jpg", "price_change"] <- "No"
kobo_data[kobo_data$source_photo == "1763210997150.jpg", "price_per_jerrycan"] <- 0
kobo_data[kobo_data$source_photo == "1763210997150.jpg", "price_per_month"] <- 0
kobo_data[kobo_data$source_photo == "1763205423836.jpg", "owner_type"] <- "None"
kobo_data[kobo_data$source_photo == "1763295731653.jpg", "users_per_day"] <- "50 to 100"
kobo_data[kobo_data$source_photo == "1763203048324.jpg", "percent_women_gatherers"] <- 80
kobo_data[kobo_data$source_photo == "1763210997150.jpg", "percent_women_gatherers"] <- 80
kobo_data[kobo_data$source_photo == "1763215236980.jpg", "percent_women_gatherers"] <- 80


kobo_data[kobo_data$source_photo == "1763029369673.jpg", "funder"]
kobo_data[kobo_data$source_photo == "1763029369673.jpg", "percent_women_gatherers"]
kobo_data[kobo_data$source_photo == "1763029369673.jpg", "price_per_jerrycan"]
kobo_data[kobo_data$source_photo == "1763029369673.jpg", "price_per_month"]
...
missing_data <- kobo_data %>%
  select(surveyor_name, uuid, source_photo, community, zone, water_source_type, surveyor_name:percent_women_gatherers, -construction_cost) %>%
...
missing_data %>%
  ...
  select(surveyor_name, source_photo, photo_display, missing_variables) %>%
...
## Outliers Output Table
```{r}
# Define exclusions
exclusions <- tribble(
  ~source_photo, ~variable,
  "1762865226663.jpg", "funder",
  "1763211609931.jpg", "percent_women_gatherers",
  "1762937610913.jpg", "percent_women_gatherers",
  "1762856007203.jpg", "percent_women_gatherers",
  "1763308469124.jpg", "percent_women_gatherers",
  "1763308969945.jpg", "percent_women_gatherers",
  "1763202790648.jpg", "percent_women_gatherers"
)

# Get numeric variables from the dataset
num_vars <- kobo_data %>%
  select(surveyor_name:percent_women_gatherers) %>%
  select(where(is.numeric)) %>%
  names()

# Calculate outliers (outside 2 SD) for each numeric variable
outliers_detailed <- kobo_data %>%
  select(surveyor_name, uuid, source_photo, community, zone, water_source_type, all_of(num_vars)) %>%
  pivot_longer(cols = all_of(num_vars),
               names_to = "variable",
               values_to = "value") %>%
  filter(!is.na(value)) %>%
  filter(!(variable %in% c("price_per_month", "price_per_jerrycan") & value == 0)) %>%
  group_by(variable) %>%
  mutate(
  ...
  ungroup() %>%
  filter(is_outlier) %>%
  anti_join(exclusions, by = c("source_photo", "variable")) %>%
  mutate(
    safe_filename = ifelse(!is.na(source_photo),
                          paste0(
                            gsub(" ", "", community), "_",
...
outliers_summary <- outliers_detailed %>%
  group_by(surveyor_name, variable) %>%
  summarise(outlier_count = n(), .groups = "drop") %>%
  pivot_wider(names_from = variable, values_from = outlier_count, values_fill = 0) %>%
  mutate(Total = rowSums(select(., -surveyor_name), na.rm = TRUE))
...
# Create detailed outlier table with embedded images
outliers_detailed %>%
  select(surveyor_name, source_photo, photo_display, water_source_type, variable, value, mean_val) %>%
  arrange(surveyor_name, source_photo, variable) %>%
  mutate(mean_val = round(mean_val, 2)) %>%
  kable(col.names = c("Surveyor", "Photo Name", "Photo", "Water Source Type", "Variable", "Value", "Mean"),
        escape = FALSE) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
```
...
```{r}
# Generate correction code for outliers
outliers_detailed_for_code <- kobo_data %>%
  select(surveyor_name, uuid, source_photo, community, zone, water_source_type, all_of(num_vars)) %>%
  pivot_longer(cols = all_of(num_vars),
               names_to = "variable",
               values_to = "value") %>%
